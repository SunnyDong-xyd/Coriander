 ...
 * Use the {@link BunnyFragment#newInstance} factory method to
...
public class BunnyFragment extends Fragment {
    ...
    public static BunnyFragment newInstance(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bunny, container, false);
